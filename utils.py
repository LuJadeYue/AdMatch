...
def plot_cmatrix(preds, labels, encoding, figsize=(8, 5), dpi=150, class_names_font_scale=1.2, matrix_font_size=12,
                 save_fig_name=None):
...
def plot_examples(images, labels, encoding, figsize=(8, 5), dpi=150, labels_fontsize=5, prediction=None,
                  save_fig_name=None):
