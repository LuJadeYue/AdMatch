...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_name", type=str, default="simdts")
    ...
    parser.add_argument("--dynamic_thresh", type=bool, default=True)
    ...
    parser.add_argument("--num_labels", type=int, default=420)
    parser.add_argument(
        "--batch_size",
        type=int,
        default=4,
